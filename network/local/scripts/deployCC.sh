...
if [ "$CC_SKIP_PACKAGE_INSTALL" = "true" ]; then
  ...
  # peer0 of motorvehicledepartment
  installChaincode 0 motorvehicledepartment
  # peer1 of motorvehicledepartment
  installChaincode 1 motorvehicledepartment
  # peer0 of licinsurance
  installChaincode 0 licinsurance
  # peer1 of licinsurance
  installChaincode 1 licinsurance
  # peer0 of bajajinsurance
  installChaincode 0 bajajinsurance
  # peer1 of bajajinsurance
  installChaincode 1 bajajinsurance
  # peer0 of benzmanufacturer
  installChaincode 0 benzmanufacturer
  # peer1 of benzmanufacturer
  installChaincode 1 benzmanufacturer
fi
...
if [ "$CHANNEL_NAME" = "evidence" ]; then
  ...
  queryInstalled 0 motorvehicledepartment

 ## approve the definition for config.orgs
  approveForMyOrg 0 motorvehicledepartment
  approveForMyOrg 0 licinsurance
  approveForMyOrg 0 bajajinsurance
  approveForMyOrg 0 benzmanufacturer
  ## check whether the chaincode definition is ready to be committed
  ## expect all of them to have approved

  checkCommitReadiness 0 motorvehicledepartment
  checkCommitReadiness 0 licinsurance
  checkCommitReadiness 0 bajajinsurance
  checkCommitReadiness 0 benzmanufacturer

  ## commit the definition
  commitChaincodeDefinition motorvehicledepartment licinsurance bajajinsurance benzmanufacturer 

  ## query to see that the definition committed successfully
  queryCommitted 0 motorvehicledepartment
  queryCommitted 0 licinsurance
  queryCommitted 0 bajajinsurance
  queryCommitted 0 benzmanufacturer
  ...
  if [ "$CC_INIT_FCN" = "NA" ]; then
    ...
    chaincodeInvokeInit motorvehicledepartment
  fi
else
